...
def load_data(path):
    ...
    print("tat ca cac file : ", len(results2))
...
def test():
    ...
    # results = read_tif_folder(TEST_PATH)
    # results = read_tif_folder(HIMA_PATH)
    results = read_tif_folder("../DATA_SV/Hima/B04B/2019/04/01")
    print(results[0]['crs'])
    # end_time = time.time()

    # results2 = read_tif_folder(HIMA_PATH, limit=3)
    # i = 0
    # for r in results2:
    #     i += 1
    #     print(i, '. ', r)
